defmodule Rumbl.VideoControllerTest do
  use Rumbl.ConnCase
  alias Rumbl.Video
  @valid_attrs %{url: "youtube.com", title: "video name", description: "video name"}
  @invalid_attrs %{title: "video name"}
  ...
  test "lists all user's videos on index", %{conn: conn, user: user} do
    ...
    other_video = insert_video(insert_user(email: "mix@gmail.com"), title: "another video")
